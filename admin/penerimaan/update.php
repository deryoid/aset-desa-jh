...
<?php
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM barang AS br LEFT JOIN sumberdana AS sd ON br.id_sumberdana = sd.id_sumberdana WHERE br.id_barang = '$id'")->fetch_array();
?>
                            ...
                            <div class="panel panel-primary panel-fill">
                                ...
                                <input type="hidden" name="id_barang" value="<?= $data['id_barang'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  id="nama_sumberdana" value="<?= $data['nama_sumberdana'] ?>" class="form-control" name="nama_sumberdana" readonly>
                                        </div>
                                        <div class="form-group">
